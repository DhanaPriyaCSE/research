...
const authapi = require("./api/auth-routes");
const profileapi = require("./api/profile-routes");
...
// app.use("/aapi", authapi);
// app.use("/papi", profileapi);
...
app.get('/home', authCheck, (req, res) => {
    callpaper.find().populate('typeofpaper').populate('indexedin').sort({ publishdate: -1 }).then((paperDetails) => {
        ...
        res.json({ message: "hello welcom to !!!" })
